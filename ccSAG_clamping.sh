...
for raw_reads in `\ls $Outdir/$Rawreaddir | grep "_R1_001.fastq$" | sed 's/_R1_001.fastq/\t/g'`;
do
cat $Outdir/$Rawreaddir >> $Outdir/raw_merge_R1_001.fastq
cat $Outdir/$Rawreaddir >> $Outdir/raw_merge_R2_001.fastq
done

$spades_path $spades_option -1 $Outdir/raw_merge_R1_001.fastq -1 $Outdir/raw_merge_R2_001.fastq -o $Outdir/raw_merge_SPAdes
...
rm $Outdir/fish_index* $Outdir/fish_index $Outdir/fish_blastresult $Outdir/fish_uniq_blastresult 
